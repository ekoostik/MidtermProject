...
INSERT INTO `user` (`id`, `username`, `password`, `enabled`, `role`, `first_name`, `last_name`, `email`, `profile_url`, `about_me`, `create_date`, `update_date`, `date_of_birth`) VALUES (14, 'testuser', 'testuser', 1, 'user', 'test', 'user', 'test@distillery.edu', 'https://i5.walmartimages.com/asr/9f0728d8-4709-4b0f-9f4b-2676443bf415.41b57ef244deb70742020c3dbeed4995.jpeg?odnHeight=580&odnWidth=580&odnBg=FFFFFF', NULL, NULL, NULL, NULL);
INSERT INTO `user` (`id`, `username`, `password`, `enabled`, `role`, `first_name`, `last_name`, `email`, `profile_url`, `about_me`, `create_date`, `update_date`, `date_of_birth`) VALUES (15, 'SuzyQ', 'doggos', 1, 'user', 'Susie', 'Carmicheal', 'reyes@distillery.edu', 'https://hellobeautiful.com/wp-content/uploads/sites/50/2015/02/screen-shot-2015-02-20-at-1-32-15-pm.png?w=456&h=350&strip=all&quality=80', NULL, NULL, NULL, NULL);
...
START TRANSACTION;
USE `vigilancedb`;
INSERT INTO `post` (`id`, `description`, `image`, `user_id`, `create_date`, `neighborhood_id`) VALUES (1, 'I have a bunch of plants I need to rehome, any takers?', 'https://secure.img1-cg.wfcdn.com/im/72551637/resize-h600-w600%5Ecompr-r85/1093/109315834/Live+Plants.jpg', 2, '2023-03-27', 1);
...
INSERT INTO `post` (`id`, `description`, `image`, `user_id`, `create_date`, `neighborhood_id`) VALUES (3, 'LOST DOG: If anyone sees a small poodle mix dog, please let me know ASAP! Her name is Coco and she\'s a little skittish! I will offer a reward of $1000 if anyone can sees her and bring her home!', 'https://www.hepper.com/wp-content/uploads/2021/11/toy-teacup-poodle-puppy.jpg', 11, '2023-12-10', 1);
...
INSERT INTO `post` (`id`, `description`, `image`, `user_id`, `create_date`, `neighborhood_id`) VALUES (6, 'Just wondering if anyone else got ding-dong ditched by a group of heathen children! I hate when they run in my prefectly manicured yard! These parents need to get it together and actually discipline these kids. Ughhh...', 'https://www.ozarksfirst.com/wp-content/uploads/sites/65/2021/04/ditch-1.gif', 4, '2023-02-03', 3);
INSERT INTO `post` (`id`, `description`, `image`, `user_id`, `create_date`, `neighborhood_id`) VALUES (7, 'Anyone need any yard work done? Call 213-423-4320 I have a son would wants to make some money over the summer to save for a video game console', NULL, 6, '2023-03-15', 3);
INSERT INTO `post` (`id`, `description`, `image`, `user_id`, `create_date`, `neighborhood_id`) VALUES (8, 'I need a dog sitter for the weekend. I have 2 dogs that are super friendly. I would prefer if they stay with them overnight, will feed them, and let them out as needed. Comment below for more details!', 'https://www.petsit.com/stuff/contentmgr/files/0/12d89c7e80c963837d3edea25b22f36e/files/find_your_local_psi_pet_sitter.jpg', 7, '2023-03-12', 5);
INSERT INTO `post` (`id`, `description`, `image`, `user_id`, `create_date`, `neighborhood_id`) VALUES (9, 'I\'m in search of a babysitter to watch my three kids on friday night. Does anyone have any recommendations? Looking for someone with experience with small kids.', NULL, 15, '2023-03-02', 5);
...
INSERT INTO `post` (`id`, `description`, `image`, `user_id`, `create_date`, `neighborhood_id`) VALUES (11, 'I have some house items im getting rid of, anyone interested in buying a couch, coffee table or a dining room table?', NULL, 2, '2023-03-16', 1);
INSERT INTO `post` (`id`, `description`, `image`, `user_id`, `create_date`, `neighborhood_id`) VALUES (12, 'I have a chinchilla I want to rehome. He name is Gus, $250. He comes with his cage, a bag of food and some bedding', 'https://m.media-amazon.com/images/W/IMAGERENDERING_521856-T1/images/I/71KLtFxO4SL.jpg', 13, '2023-03-16', 3);
INSERT INTO `post` (`id`, `description`, `image`, `user_id`, `create_date`, `neighborhood_id`) VALUES (13, 'Anyone know of a good English tutor in the neighborhood? My kid is in need of one to help her pass her comp class.', NULL, 11, '2023-03-16', 5);
INSERT INTO `post` (`id`, `description`, `image`, `user_id`, `create_date`, `neighborhood_id`) VALUES (14, 'Hey guys I was in the neighborhood dog park yesterday and noticed there was a hole in the fence. If your dog is a runner beware of that hole. I put in a request for maintenence to look at it.', NULL, 12, '2023-03-16', 5);
...
INSERT INTO `address` (`id`, `address1`, `address2`, `city`, `state`, `zip_code`, `neighborhood_id`) VALUES (17, '3792 N Righthand Drive', NULL, 'Silverton', 'CO', '80102', 4);
...
INSERT INTO `household` (`id`, `occupants`, `address_id`, `user_id`) VALUES (15, 2, 15, 15);
