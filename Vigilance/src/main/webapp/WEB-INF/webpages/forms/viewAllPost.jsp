        ...
        <article class="post vt-post">
            <div class="row">
                    ...
                    <div class="author-info author-info-2">
                        <ul class="list-inline">
                            <li>
                                <div class="info">
                                    <p>Posted on:</p>
                                    <strong>${post.createDate}</strong></div>
                            </li>
                ...
                <div class="col-xs-12 col-sm-7 col-md-7 col-lg-8">
                    <div class="caption">
                        <h3 class="md-heading"><a href="#">${post.user.firstName}</a></h3>
                        <p> ${post.description} </p>
                        <a class="btn btn-default" href="getPostById.do?id=${post.id}" role="button">Read Post</a> </div>
                </div>
            </div>
        </article>
           ...
           <button onclick="window.location.href='createPost.do';">New Post</button>
