						...
						<td><c:choose>
								<c:when test="${ !empty loggedinuser.household.vehicles}">
									<c:forEach var="v" items="${loggedinuser.household.vehicles}">
										<form action="vehicleUpdated.do" method="POST">
										  <input type="hidden" name="id" value="${v.id}" /><br>
										  Make <input type="text" name="make" value="${v.make}"/><br>
										  Model <input type="text" name="model" value="${v.model}"/><br>
										  Color <input type="text" name="color" value="${v.color}"/><br>
										  Description <input type="text" name="description" value="${v.description}"/><br>
										  <input type="hidden" name="householdId" /><br>
